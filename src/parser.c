...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [224] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selects, 5),
  ...
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selects, 2),
  ...
  [297] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_selects_repeat1, 2), SHIFT_REPEAT(56),
  [300] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_selects_repeat1, 2),
